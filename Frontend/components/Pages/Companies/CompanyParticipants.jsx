      ...
      class CompanyParticipants extends React.Component {
        ...
        componentWillReceiveProps(nextProps) {
          ...
          if (nextProps.currentTabIndex !== this.props.currentTabIndex) {
            ...
            if (this.viewModel.participants.length === 0) {
        ...
        isValidTabIndex() {
          ...
          return this.props.currentTabIndex === 1 || (this.nextProps && this.nextProps.currentTabIndex === 1);
        }
        ...
        getParticipants() {
          ...
          if (this.isValidTabIndex()) {
            ...
            if (this.companyViewModel.selectedCompForContacts) {
              ...
              this.viewModel.isPartLazyLoading = true;
            }
        ...
        getTrainings() {
          ...
          if (this.viewModel.selectedMainIndex >= 0 && this.viewModel.selectedMainIndex < this.viewModel.participants.length) {

            const params = {
              companyID: this.companyViewModel.selectedCompForContacts.id,
              personID: this.viewModel.participants[this.viewModel.selectedMainIndex].id,
              statusFilter: 1,
            ...
            Helper.RunPromise(
              {
                promise: Helper.FetchPromiseGet('/company/GetParticipantTrainings', params),
                success: data => {
          ...
          return (
            ...
            value.isLazyWait ?
              ...
              <tr key={value.genId}>
                ...
                <td className="s-td-cell-name-xshort" style={{ cursor: 'auto' }}>{value.header.title}</td>
              ...
              <Row className="s-row-top">
                ...
                <Col xs={12} sm={this.viewModel.showCourseDetails ? 9 : 7}>
                  <div ref={r => this.affixTarget = ReactDOM.findDOMNode(r)} className={this.state.affix ? 's-portlet-fixed' : 's-portlet'}
                    style={{
                      width: this.viewModel.showCourseDetails ? 870 : 670
                    }}>
                    <div className="s-portlet-body">
                      <table className="s-table" style={{ marginBottom: 20 }}>
                        <tbody>
